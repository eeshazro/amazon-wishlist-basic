...
\restrict YGA7Ui47bEgVujk3zu0HPsBTjDZivPYn41txg8coLQ07121gos9xnhsfYUNHSqK
...
--
-- Name: COLUMN wishlist_invite.access_type; Type: COMMENT; Schema: collab; Owner: wishlist_user
--
...
--
-- Name: wishlist_item_comment; Type: TABLE; Schema: collab; Owner: wishlist_user
--
...
ALTER TABLE collab.wishlist_item_comment OWNER TO wishlist_user;

--
-- Name: TABLE wishlist_item_comment; Type: COMMENT; Schema: collab; Owner: wishlist_user
--
...
--
-- Name: wishlist_item_comment_id_seq; Type: SEQUENCE; Schema: collab; Owner: wishlist_user
--
...
ALTER TABLE collab.wishlist_item_comment_id_seq OWNER TO wishlist_user;

--
-- Name: wishlist_item_comment_id_seq; Type: SEQUENCE OWNED BY; Schema: collab; Owner: wishlist_user
--
...
--
-- Name: wishlist_item_comment id; Type: DEFAULT; Schema: collab; Owner: wishlist_user
--
...
1	1	EpYcMjcLd-kAzLji	2025-08-25 14:49:40.861	2025-08-22 14:49:40.862213	view_only
2	1	rffdp_QMtaxb0XIP	2025-08-27 20:11:11.438	2025-08-24 20:11:11.439378	view_only
3	1	test-token-123	2025-08-26 12:10:32.506417	2025-08-25 12:10:32.506417	view_edit
\.


--
-- Data for Name: wishlist_item_comment; Type: TABLE DATA; Schema: collab; Owner: wishlist_user
--

COPY collab.wishlist_item_comment (id, wishlist_item_id, user_id, comment_text, created_at) FROM stdin;
1	1	1	This is a test comment	2025-08-25 12:10:32.453029
\.
...
SELECT pg_catalog.setval('collab.wishlist_invite_id_seq', 3, true);


--
-- Name: wishlist_item_comment_id_seq; Type: SEQUENCE SET; Schema: collab; Owner: wishlist_user
--

SELECT pg_catalog.setval('collab.wishlist_item_comment_id_seq', 1, true);
...
--
-- Name: wishlist_item_comment wishlist_item_comment_pkey; Type: CONSTRAINT; Schema: collab; Owner: wishlist_user
--
...
--
-- Name: idx_wishlist_item_comment_created; Type: INDEX; Schema: collab; Owner: wishlist_user
--
...
--
-- Name: idx_wishlist_item_comment_item; Type: INDEX; Schema: collab; Owner: wishlist_user
--
...
--
-- Name: idx_wishlist_item_comment_user; Type: INDEX; Schema: collab; Owner: wishlist_user
--
...
--
-- Name: wishlist_item_comment wishlist_item_comment_user_id_fkey; Type: FK CONSTRAINT; Schema: collab; Owner: wishlist_user
--
...
--
-- Name: wishlist_item_comment wishlist_item_comment_wishlist_item_id_fkey; Type: FK CONSTRAINT; Schema: collab; Owner: wishlist_user
--
...
\unrestrict YGA7Ui47bEgVujk3zu0HPsBTjDZivPYn41txg8coLQ07121gos9xnhsfYUNHSqK
